...
CMD ["python", "app.py"]`;
  ...
  const standaloneCsvProcessor = `// Standalone CSV Processor - Works WITHOUT meldra-app
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <Alert className="mb-8 bg-emerald-500/10 border-emerald-500/30">
          ...
          <AlertDescription className="text-slate-200">
            ...
            Run it anywhere - no dependencies on meldra-app or any platform. Your intellectual property, your control.
          </AlertDescription>
        </Alert>
            ...
            <div className="bg-slate-900/80 border border-slate-700/50 rounded-2xl p-6">
              ...
              <Alert className="mb-6 bg-amber-500/10 border-amber-500/30">
                ...
                <AlertDescription className="text-slate-300">
                  <strong className="text-amber-300">How to Extract from Meldra:</strong>
                  <ol className="list-decimal ml-5 mt-2 space-y-1">
                    <li>Go to Meldra Dashboard → Code tab</li>
