    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 py-12">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          ...
          <Card className="bg-white dark:bg-slate-900/80 backdrop-blur-xl border-slate-200 dark:border-slate-700/50 shadow-lg">
            <CardHeader>
              <div className="w-12 h-12 bg-emerald-500/20 dark:bg-emerald-500/20 rounded-lg flex items-center justify-center mb-4">
                <Lock className="w-6 h-6 text-emerald-600 dark:text-emerald-400" />
              </div>
              <CardTitle className="text-slate-900 dark:text-white">Password Security</CardTitle>
            </CardHeader>
            <CardContent className="text-slate-600 dark:text-slate-300">
              <p>Passwords are <strong className="text-slate-900 dark:text-white">hashed with bcrypt</strong>. We cannot see your actual password - it's irreversible and secure.</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white dark:bg-slate-900/80 backdrop-blur-xl border-slate-200 dark:border-slate-700/50 shadow-lg">
            <CardHeader>
              <div className="w-12 h-12 bg-red-500/20 dark:bg-red-500/20 rounded-lg flex items-center justify-center mb-4">
                <Shield className="w-6 h-6 text-red-600 dark:text-red-400" />
              </div>
              <CardTitle className="text-slate-900 dark:text-white">Admin-Only Logs</CardTitle>
            </CardHeader>
            <CardContent className="text-slate-600 dark:text-slate-300">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          <Card className="bg-emerald-50 dark:bg-emerald-900/20 backdrop-blur-xl border-emerald-200 dark:border-emerald-500/30 shadow-lg">
            <CardHeader>
            ...
            <CardContent className="text-slate-700 dark:text-slate-300 space-y-2">
              <p>✅ <strong className="text-slate-900 dark:text-white">Account Info:</strong> Email, hashed password, name</p>
              <p>✅ <strong className="text-slate-900 dark:text-white">Subscription:</strong> Plan type, payment status, usage counts</p>
              <p>✅ <strong className="text-slate-900 dark:text-white">Login History:</strong> Timestamps, IPs (admin only - security)</p>
              <p>✅ <strong className="text-slate-900 dark:text-white">Activity Metadata:</strong> Action types, no content (admin only)</p>
          ...
          <Card className="bg-red-50 dark:bg-red-900/20 backdrop-blur-xl border-red-200 dark:border-red-500/30 shadow-lg">
            <CardHeader>
            ...
            <CardContent className="text-slate-700 dark:text-slate-300 space-y-2">
              <p>❌ <strong className="text-slate-900 dark:text-white">File Contents:</strong> Excel, CSV, ZIP, PDF data</p>
              <p>❌ <strong className="text-slate-900 dark:text-white">AI Prompts/Responses:</strong> Your questions and answers</p>
        ...
        <Card className="bg-white dark:bg-slate-900/80 backdrop-blur-xl border-slate-200 dark:border-slate-700/50 mb-12 shadow-lg">
          <CardHeader>
            <CardTitle className="text-slate-900 dark:text-white text-2xl">Compliance Standards</CardTitle>
          </CardHeader>
        ...
        <Card className="bg-white dark:bg-slate-900/80 backdrop-blur-xl border-slate-200 dark:border-slate-700/50 mb-12 shadow-lg">
          <CardHeader>
            <CardTitle className="text-slate-900 dark:text-white text-2xl">Your Rights & Controls</CardTitle>
          </CardHeader>
          <CardContent className="text-slate-700 dark:text-slate-300 space-y-3">
            <p><strong className="text-slate-900 dark:text-white">Access Your Data:</strong> View and download your subscription info and activity history</p>
            <p><strong className="text-slate-900 dark:text-white">Delete Your Data:</strong> Delete your account and all associated data (within 30 days)</p>
            <p><strong className="text-slate-900 dark:text-white">Correct Your Data:</strong> Update your email, name, and preferences</p>
            <p><strong className="text-slate-900 dark:text-white">Export Your Data:</strong> Download your data in JSON format</p>
            <p><strong className="text-slate-900 dark:text-white">Contact Admin:</strong> Questions? Email support@meldra.ai</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-white dark:bg-slate-900/80 backdrop-blur-xl border-slate-200 dark:border-slate-700/50 mb-12 shadow-lg">
          <CardHeader>
            <CardTitle className="text-slate-900 dark:text-white text-2xl">Best Practices for Users</CardTitle>
          </CardHeader>
          <CardContent className="text-slate-700 dark:text-slate-300 space-y-3">
            <p>✅ <strong className="text-slate-900 dark:text-white">Use a strong password:</strong> At least 12 characters, mix of letters/numbers/symbols</p>
            <p>✅ <strong className="text-slate-900 dark:text-white">Logout on shared computers:</strong> Always logout after use</p>
            <p>⚠️ <strong className="text-amber-700 dark:text-amber-300">Don't upload sensitive data:</strong> No SSNs, medical records, or credit cards</p>
            <p>✅ <strong className="text-slate-900 dark:text-white">Monitor your account:</strong> Check activity dashboard regularly</p>
            <p>✅ <strong className="text-slate-900 dark:text-white">Report suspicious activity:</strong> Contact us immediately if something seems wrong</p>
          </CardContent>
        </Card>

        {/* Contact */}
        <Card className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 backdrop-blur-xl border-blue-200 dark:border-blue-500/30 shadow-lg">
          <CardHeader>
            <CardTitle className="text-slate-900 dark:text-white text-2xl">Security Contact</CardTitle>
          </CardHeader>
          <CardContent className="text-slate-700 dark:text-slate-300 space-y-3">
            <p><strong className="text-slate-900 dark:text-white">Report Security Issues:</strong> security@meldra.ai</p>
            <p><strong className="text-slate-900 dark:text-white">General Questions:</strong> support@meldra.ai</p>
            <p><strong className="text-slate-900 dark:text-white">Privacy Policy:</strong> <a href="/privacy" className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 underline">/privacy</a></p>
            <p className="text-sm text-slate-600 dark:text-slate-400 mt-4">
        ...
        {/* Footer */}
        <div className="text-center mt-12 text-slate-600 dark:text-slate-400 text-sm">
          <p>Last Updated: January 15, 2025 • Version 1.0</p>
          <p className="mt-2">
            <a href="/privacy" className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300">Privacy Policy</a>
            {' • '}
            <a href="/disclaimer" className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300">Terms of Service</a>
          </p>
        </div>
      </div>
    </div>
